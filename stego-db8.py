...
to_hide_og = read_and_convert_image("img/lena.JPG")
to_send_og = read_and_convert_image("img/lena.JPG")

# plot cover and image that will be hidden
show_image_subplot(to_send_og, 1, "Imagem de Cobertura")
...
dwt_labels = ["Aproximação", "Detalhes Horizontais", "Detalhes Verticais", "Detalhes Diagonais"]

show_coefficients_subplot([cAr, cHr, cVr, cDr], 3, dwt_labels)
